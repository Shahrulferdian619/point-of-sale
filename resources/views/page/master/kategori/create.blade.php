            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Buat Kategori</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tbody class="body">
                            <tr class="tr-0">
                                <td>
                                    <input type="text" class="form-control" name="kategori[0][nama_kategori]" style="width: 103%" placeholder="wajib diisi">
                                </td>
                                <td>
                                    <input type="text" class="form-control" name="kategori[0][keterangan]" placeholder="opsional">
                                </td>
                                <td>
        ...
        $(document).ready(function () {
            ...
            $('.plus').on('click', function(){
                let tr = `
                    <tr class="tr-${rowBody}">
                        <td>
                            <input type="text" class="form-control" name="kategori[${rowBody}][nama_kategori]" style="width: 103%" placeholder="wajib diisi">
                        </td>
                        <td>
                            <input type="text" class="form-control" name="kategori[${rowBody}][keterangan]" placeholder="opsional">
                        </td>
                        <td>
                            <i style="font-size: 120%; color: red; margin-top: 10px;" class="fas fa-trash remove"></i>
                        </td>
